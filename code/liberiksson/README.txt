...
also produces candidates for embedded factor patterns in type D.
...
expression.  We also implement a combinatorial test for the Deodhar
condition.

The client program classify.cpp contains the main() function, and
performs the classification and generates enumerative data.
...
It takes about 25 minutes to run the classification on a 3.0GHz
machine.
...
Finished:  found 1426 Deodhar elements (out of 1428 short-braid-avoiding elements processed, used 4 non-Deodhar patterns, and 0 matched bad 1-line pattern in D8).
...
Finished:  found 6791 Deodhar elements (out of 7064 short-braid-avoiding elements processed, used 1072 non-Deodhar patterns, and 1 matched bad 1-line pattern in D8).
...
Finished:  found 2341 Deodhar elements (out of 2419 short-braid-avoiding elements processed, used 329 non-Deodhar patterns, and 0 matched bad 1-line pattern in D8).
